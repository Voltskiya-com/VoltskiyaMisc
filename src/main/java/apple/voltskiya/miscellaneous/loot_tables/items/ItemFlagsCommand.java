...
import apple.lib.acf.annotation.*;
...
public class ItemFlagsCommand extends BaseCommand implements SendMessage {
    public ItemFlagsCommand() {
        ...
        VoltskiyaPlugin.get().getCommandManager().getCommandCompletions().registerAsyncCompletion("get_special_items",
                                                                                                  (c) -> SpecialItemDatabase
                                                                                                          .get()
                                                                                                          .getNames()
        );
    }
